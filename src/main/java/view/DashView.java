 ...
 * @author PV
 */
public class DashView extends javax.swing.JFrame implements ActionListener{
...
//        pnlNews.setBackground(new java.awt.Color(245, 245, 245));
        ...
        searchField.setFont(new Font("Calibri",Font.BOLD,16));
...
//        searchField.setBounds(0, 0, 200, 25);
        ...
        typeSearch = new Combobox<String>();
        typeSearch.setModel(new javax.swing.DefaultComboBoxModel(optionsToChoose));
        typeSearch.setSelectedIndex(-1);
        typeSearch.setLabeText("Tìm kiếm theo");
        ...
        searchButton.setBackground(new Color(32, 136, 203));
        ...
        addButton.setBackground(new Color(32, 136, 203));
        ...
        deleteButton.setBackground(new Color(138, 115, 4));
        ...
        editButton.setBackground(new Color(138, 115, 4));
        ...
        sortButton.setBackground(new Color(32, 136, 203));
        sortButton.setForeground(Color.WHITE);
        sortButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        
        typeSort = new Combobox<String>();
        typeSort.setModel(new javax.swing.DefaultComboBoxModel(optionsToChoose));
        typeSort.setSelectedIndex(-1);
        typeSort.setLabeText("Sắp xếp theo");
...
//        pnlBody.add(pnlNews, "card4");
    ...
    private void btnMaximizeActionPerformed(java.awt.event.ActionEvent evt) {                                            
        if(maximized){
            ...
            DashView.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
            GraphicsEnvironment env = GraphicsEnvironment.getLocalGraphicsEnvironment();
            DashView.this.setMaximizedBounds(env.getMaximumWindowBounds());
            maximized = false;
        }else{
